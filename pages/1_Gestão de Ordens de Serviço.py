    ...
    with st.form(key="ordem"):
        ...
        with st.container():
            ...
            if submit_button:
                ...
                # Inicializa el DataFrame con todas las columnas necesarias
                data = pd.DataFrame(
                    [
                        {
                            ...
                            'total_serviço': None,  # Columna vacía
                            ...
                            '30_porc': None,  # Columna vacía
                            'total_valor_pecas': None,  # Columna vacía
                            'forma_de_pagamento': None,  # Columna vacía
                            'pagamento_parcial': None,  # Columna vacía
                            'valor_pago_parcial': None,  # Columna vacía
                            'data_prox_pag': None,  # Columna vacía
                            'valor_prox_pag': None,  # Columna vacía
                            'pag_total': None,  # Columna vacía
                            'valor_pag_total': None  # Columna vacía
                        }
                    ]
                )
