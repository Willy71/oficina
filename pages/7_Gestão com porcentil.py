...
if action == "Nova ordem de serviço":
    ...
    with st.form(key="ordem"):
        ...
        with st.container():  
            ...
            with col160:
                quant_peca_1 = st.text_input(label="", placeholder="Escribe aquí...", label_visibility="hidden")
            with col161:
                desc_peca_1 = st.text_input(label="", placeholder="Escribe aquí...", label_visibility="hidden")
            with col162:
                valor_peca_1 = st.text_input(label="", placeholder="Escribe aquí...", label_visibility="hidden")
