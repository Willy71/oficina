...
if action == "Nova ordem de serviço":
    ...
    with st.form(key="ordem"):
        ...
        with st.container():  
            ...
            with col160:
                quant_peca_1 = st.text_input("", "Quant", label_visibility="hidden")
            with col161:
                desc_peca_1 = st.text_input("", "Descrição", label_visibility="hidden")
            with col162:
                valor_peca_1 = st.text_input("", "Valor unit", label_visibility="hidden")
